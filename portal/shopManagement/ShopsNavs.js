    ...
    const SHOPS_MANAGEMENT_HEADER = { xpath: "//a[@class='wraper-title' and text()='Shops Management']"};
    const SHOPS_NAV = { xpath: "//a[@class='nav-link' and text()='Shops']"};
    const APPLICATIONS_NAV = { xpath: "//a[@class='nav-link' and text()='Applications']"};
    const VENDOR_SIGN_UP_FORM_NAV = { xpath: "//a[@class='nav-link' and text()='Vendor SignUp Form']"};
    const SHOP_CATEGORIES_NAV = { xpath: "//a[@class='nav-link' and text()='Shop Categories']"};
